...
export default function Home() {
  ...
  return (
    <main className=" mx-[108px] flex justify-between items-center">
      <section className=' w-[544px]'>
        <h1 className={`uppercase font-[400] text-[101px] leading-[90.9px] ${bebasNeue.className}`}>hi, i am osita jerry</h1>
        <p className={`font-[400] text-lg text-[var(--dark-primary-color)] ${manrope.className}`}>A front-end developer, who is passionate about building accessible and user friendly websites.</p>
        <div className=' flex gap-4'>
          <button className={ `btn flex items-center gap-3 ${manrope.className}`}>contact me <div className=' w-4 h-4 rounded-full bg-[#222] mr-3'></div></button>
          <div className=' bg-[#222] h-[54px] w-[54px] rounded-full flex justify-center items-center ' >
      ...
      <div className='relative h-[520px] w-[400px] bg-red-500 rounded-2xl'>
        <Image src={Mypic} alt=' my picture'   layout='fill' objectFit='cover' className='object-none '></Image>
      </div>
    </main>
  )
}
