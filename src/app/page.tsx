...
export default function Home() {
  ...
  return (
    <main className=" mx-[30px]  mt-[3vh] h-auto flex flex-col justify-between gap-10  items-center py-10 sm:gap-16 sm:mx-[50px] md:mx-[60px]  lg:py-0 lg:flex-row lg:h-[88vh] lg:gap-5 xl:mx-[108px]">
      {/* <----------------------- LEFT SECTION -----------------------------> */}
      <section className=" w-[90%]   lg:w-[340px] xl:w-[544px] ">
        ...
        <div>
          <h1
            className={clsx(
              ` uppercase font-[400] text-[57px] leading-[55px] text-[#0a0a0a] sm:text-[70px] sm:leading-[75px] md:text-[90px] md:leading-[85px] xl:text-[101px] xl:leading-[100px]  ${bebasNeue.className}`,
              {
                "text-[#fff]": theme === "dark-bg",
              }
            )}
          >
            hi, i am <br /> osita&nbsp;jerry
          </h1>
          <p
            className={clsx(
              `font-[400] text-[15px]  text-[#c7c7c7] pb-[40px] xl:text-lg  ${manrope.className}`,
              {
                "text-[#000]": theme === "light-bg",
              }
            )}
          >
        ...
        {/* <-----------------------  CONTACT ME -----------------------------> */}
        <div className=" w-auto h-auto flex gap-2 -4 mx-0 sm:gap  lg:w-[80%] ">
          <button
            className={`btn text-[10px] px-4 pr-1 pl-4 flex items-center gap-3 sm:text-[16px]  sm:px-5 sm:pr-1.5 sm:pl-6 ${manrope.className}`}
          >
            contact me{" "}
            <div className=" w-2 h-2 mr-1.5  rounded-full bg-[#222] md:w-4 md:h-4 md:mr-3"></div>
          </button>
      ...
      <section className=" mx-[]">
        <div className="relative h-[420px] w-[70vw] sm:h-[520px]  md:w-[400px]  ">
          <Image
            src={Mypic}
            alt=" my picture"
            layout="fill"
