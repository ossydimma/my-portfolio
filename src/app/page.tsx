...
export default function Home() {
  ...
  return (
    <main className=" mx-[30px]  mt-[3vh] h-auto flex flex-col justify-between gap-10  items-center py-10 sm:gap-16 sm:mx-[50px] md:mx-[60px]  lg:py-0 lg:flex-row lg:h-[88vh] lg:gap-3 xl:mx-[108px]">
      {/* <----------------------- LEFT SECTION -----------------------------> */}
      <section className=" w-[90%]   lg:w-[340px] xl:w-[544px] ">
        ...
        <div>
          ...
          <p
            className={clsx(
              `font-[400] text-[15px]  text-[var(--dark-primary-color)] pb-[40px] xl:text-lg  ${manrope.className}`,
              {
