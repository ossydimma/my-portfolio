...
export default function RootLayout({
  ...
  const [showDescrip, setshowDescrip] = useState<boolean>(window.innerWidth < 640 ? true : false);
              ...
              >
                ...
                <li>
                  <div
                    ...
                    onMouseEnter={() =>{window.innerWidth > 640 ? setshowDescrip(true) : ''}}
                    onMouseLeave={() =>{window.innerWidth > 640 ? setshowDescrip(false) : ''}}
                  >
