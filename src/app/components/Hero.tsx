      ...
      <div className=" mx-[5%] mb-8  mt-[12vh] h-auto flex flex-col justify-between gap-10  items-center py-10 sm:gap-16 sm:mx-[50px] md:mx-[60px]  lg:py-0 lg:flex-row lg:h-[88vh] lg:gap-5 xl:mx-[108px]">
        ...
        <section className=" w-[90%]   lg:w-[480px] xl:w-[544px] ">
          ...
          <div className="text-center sm:text-left">
            <h1
              className={` uppercase font-[400] text-[40px]  leading-[42px]  text-[#0a0a0a]  sm:text-[57px] sm:leading-[58px] md:text-[65px] md:leading-[65px] xl:text-[90px] xl:leading-[90px] dark:text-[#fff] ${SpaceGrotesk.className}`}
            >
              hi, i am <br />{" "}
          ...
          {/* <-----------------------  CONTACT ME -----------------------------> */}
          <div className=" w-auto h-auto flex  flex-row-reverse justify-center gap-2 -4 mx-0 sm:justify-end sm:gap  lg:w-[80%] lg:gap-4 ">
            <a
              href="/Resume.pdf"
              download
              className={` uppercase shadow-2xl font-bold bg-gradient-to-l from-[#8F00FF] to-black py-4 px-14 rounded-tr-none   rounded-[200px] text-[10px] text-white pr-1 pl-4 flex items-center gap-3 border-[2px] border-[#222]  dark:border-[#c7c7c7] sm:text-[16px]  sm:px-5 sm:pr-6 sm:pl-4 ${SpaceGrotesk.className}}`}
            >
