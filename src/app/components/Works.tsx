      ...
      <main className="border-y-2 border-[#484848] h-auto w-full">
        <div className="px-[4%] lg:px-[40px]   my-20 w-[100%] ">
            ...
            <header className={`text-center  mb-20 ${SpaceGrotesk.className}`}>
                <h1 className={`${SpaceGrotesk.className} uppercase text-[30px] heading-txt font-[400] text-[#0a0a0a] dark:text-white md:text-[35px] lg:text-[65px]`}>Featured Projects</h1>
            ...
            <section className={`   pb-[120px]  flex flex-col  items-center justify-center  gap-14 lg:flex-row xl:gap-[110px] `}>
                <div className={`w-[98%] px-[2%] py-12   rounded-xl bg-[#1A1A1A] flex justify-center items-center sm:w-[96%] sm:px-[7%] sm:py-16 lg:px-16  lg:py-20 lg:w-auto`}>
                    <Image 
                        src={SneakerImg}
                        alt=" seakers"
                        width={380}
                        height={300}
                        className=" border-black border-2 w-[86%] lg:w-[390px]  rounded-xl min-w-[100px]"
                    />
                </div>
